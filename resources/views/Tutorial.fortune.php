...
<% part("content") %>
    ...
    <section id="routes">
        <h3>Routes</h3>
        Create new routes in <b>config/http/routes.php</b>. To handle each route, add methods to <b>src/Project/Application/Http/Controllers/Tutorial.php</b>.
    </section>
    <section id="views">
        <h3>Views</h3>
        <p>
        ...
        <p>
            If you want to create <i>ViewBuilders</i>, add them to <b>src/Project/Application/Http/Views/Builders</b>. Then, register each <i>ViewBuilder</i> to the appropriate template in <b>src/Project/Application/Bootstrappers/Http/Views/BuildersBootstrapper.php</b>.
        </p>
    </section>
